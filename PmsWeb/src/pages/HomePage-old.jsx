...
export default function HomePage() {
  const stats = [
    { label: 'Bu Ay Rezervasyon', value: '24', icon: Calendar, color: '#667eea' },
    { label: 'Aktif Konuklar', value: '8', icon: Users, color: '#f093fb' },
    { label: 'Müsait Odalar', value: '12', icon: Home, color: '#22c55e' },
    { label: 'Gelir (Bu Ay)', value: '12,500 ₺', icon: TrendingUp, color: '#f5576c' },
  ];
